...
class IndexMgr {
    ...
    */
   public void createIndex(String idxname, String tblname, String fldname, int idxtype, Transaction tx) {
   ...
   public Map<String,IndexInfo> getIndexInfo(String tblname, Transaction tx) {
      ...
      while (ts.next())
         ...
         int idxtype = ts.getInt("indextype");
