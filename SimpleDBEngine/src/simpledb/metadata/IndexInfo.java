...
public class IndexInfo {
   ...
   public IndexInfo(String idxname, String fldname, Schema tblSchema,
                    Transaction tx,  StatInfo si, int idxtype) {
    ...
    */
   public Index open() {
      return this.type == 0 ? new HashIndex(tx, idxname, idxLayout) : new BTreeIndex(tx, idxname, idxLayout);
   }
   ...
   public int blocksAccessed() {
      ...
      return this.type == 0 ? HashIndex.searchCost(numblocks, rpb) : BTreeIndex.searchCost(numblocks, rpb);
   }
