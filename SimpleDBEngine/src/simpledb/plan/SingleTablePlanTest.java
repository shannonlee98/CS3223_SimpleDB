...
public class SingleTablePlanTest {
	public static void main(String[] args) throws Exception {
      ...
      Transaction tx = db.newTx();
		...
		Term t = new Term(new Expression("majorid"), new CondOp("="), new Expression(new Constant(10)));
		Predicate pred = new Predicate(t); 
		Plan p2 = new SelectPlan(p1, pred);

		// the Select node for "gradyear = 2020"
		Term t2 = new Term(new Expression("gradyear"), new CondOp("="), new Expression(new Constant(2020)));
